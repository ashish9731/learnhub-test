...
export default function AdminProfile({ userEmail = 'admin@company.com' }: AdminProfileProps) {
          ...
          <div className="px-6 py-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center">
                  <Building2 className="h-4 w-4 text-gray-400 mr-2" />
                  <span className="text-sm text-gray-900">Demo Company</span>
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                {isEditing ? (
                  ...
                  <p className="text-sm text-gray-900">{profile?.bio || 'Learning administrator responsible for managing course assignments, user progress tracking, and generating detailed analytics reports for organizational learning initiatives.'}</p>
                )}
              </div>
            </div>
          </div>
