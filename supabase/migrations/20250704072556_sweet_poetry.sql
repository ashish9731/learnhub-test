/*
  # Clean Slate RLS Policies

  1. Security Changes
    - Remove all email-specific references in RLS policies
    - Use role-based access control instead of email-based
    - Fix storage policies for profile pictures, podcasts, and documents
    - Ensure proper access for all user types

  2. Changes
    - Drop all existing policies
    - Create new role-based policies for all tables
    - Fix storage bucket policies
    - Ensure authenticated users can upload profile pictures
*/
