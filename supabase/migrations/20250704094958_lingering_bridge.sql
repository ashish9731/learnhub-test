/*
  # Fix Storage URLs and Permissions

  1. Storage Buckets
    - Ensure all required storage buckets exist
    - Set proper public access settings
    - Fix permissions for file access

  2. Storage Policies
    - Create proper policies for each bucket
    - Allow authenticated users to access files
    - Ensure super admins can manage all files
    - Fix user-specific access controls

  3. URL Generation
    - Ensure proper URL structure for uploaded files
    - Fix any issues with URL generation
*/
