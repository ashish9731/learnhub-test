/*
  ...
  1. Purpose
    - Ensure podcast_likes table exists with proper structure
    - Add proper indexes for performance
    - Fix RLS policies by checking if they exist before creating
    - Ensure proper triggers for activity logging
*/
