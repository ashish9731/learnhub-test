/*
  ...
  1. Problem
    - Performance advisor shows multiple unused indexes
    - These indexes are consuming storage space and slowing down writes
    - They need to be removed to improve database performance
