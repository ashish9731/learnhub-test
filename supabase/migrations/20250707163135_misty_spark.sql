/*
  # Fix Super Admin Company Assignment and Course Description

  1. Problem
    - Super admin users should not be assigned to any company
    - Error: "User exists but is not assigned to a company"
    - Need to update the validation function to properly handle super admin users

  2. Solution
    - Update the validate_user_company_assignment function to ensure super admins don't need company_id
