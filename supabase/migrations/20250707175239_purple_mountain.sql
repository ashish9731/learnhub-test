/*
  # Fix Audit Logs Constraint and User Authentication
  ...
  1. Problem
    ...
    - Need to modify the constraint to allow NULL values for user_id
  ...
  2. Solution
    ...
    - Ensure proper authentication flow for all user types
*/
